...
from ..artifacts.variants import RankingRefused, parse_ordering, rank_group
...
def _run_stage(
    ...
    *,
    ...
    if stage.name == "distill" and brain is not None:
        committed_at, commit_sha = write_to_brain(brain, run_id, turn.text)
